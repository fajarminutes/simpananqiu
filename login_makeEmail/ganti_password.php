...
session_start();
include '../koneksi.php';
// Periksa apakah session authenticated_user dan expiration ada
if (!isset($_SESSION['authenticated_user']) || !isset($_SESSION['expiration'])) {
...
$id_user = $_SESSION['authenticated_user'];
...
if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE users SET password = '$hashedPassword' WHERE id_user = $id_user";
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Ganti Password </h2>
				</div>
			</div>
			<div class="row justify-content-center">
